 ...
 const handler = async (m, {conn, args, usedPrefix, command}) => { 
   ...
   try { 
     ...
     if (/webp|image|video/g.test(mime)) { 
       ...
       if (!img) throw `_. ᩭ✎Responda a una imagen, video o gif_`; 
       let out; 
       try { 
       ...
       else return m.reply('_. ᩭ✎El enlace no es válido, debe terminar en .jpg_'); 
     } 
   } catch (e) { 
     console.error(e); 
     if (!stiker) stiker = e; 
     ...
     else throw '_. ᩭ✎Responda a una imagen, video o gif_'; 
   } 
 }; 
 handler.help = ['sfull']; 
