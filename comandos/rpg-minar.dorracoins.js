let handler = async (m, {conn, isPrems}) => {
  ...
  if (new Date() - global.db.data.users[m.sender].lastdiamantes < 600000)
    throw `*⏱️ Vuelva en ${msToTime(time - new Date())} para continuar minando Coins ⛏️*`;
...
handler.command = ["minarnightcorecoins", "miming4", "mine4", "minarcoins", "minarcoims", "minardorrecoins"];
handler.fail = null;
handler.exp = 0;
