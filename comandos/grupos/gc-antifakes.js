...
handler.before = async function (m) {
  if (m.sender.startsWith("234" || "234")) {
    ...
    conn.reply("_Antifake  Activado lo siento seras expulsado del grupo.🍁_");
  ...
  if (m.sender.startsWith("84" || "84")) {
    global.db.data.users[m.sender].banned = true;
    m.reply("_Antifake  Activado lo siento seras expulsado del grupo.🍁_");
    conn.groupParticipantsUpdate(m.chat, [m.sender], "remove");
  }
  ...
  if (m.sender.startsWith("98" || "98")) {
    global.db.data.users[m.sender].banned = true;
    conn.reply("_Antifake  Activado lo siento mirey seras expulsado del grupo.🍁_");
    conn.groupParticipantsUpdate(m.chat, [m.sender], "remove");
  }
  if (m.sender.startsWith("377" || "377")) {
    global.db.data.users[m.sender].banned = true;
    conn.reply("Antifake  Activado lo siento seras expulsado del grupo.🍁_");
    conn.groupParticipantsUpdate(m.chat, [m.sender], "remove");
  }
};
