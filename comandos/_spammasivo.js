...
const grupo = `https://chat.whatsapp.com/KlRcEf88snBEEOA80JXzw5A`
const grupo1 = 'https://chat.whatsapp.com/JegOp8NUSMd08vn75s4hkaj'
const grupo2 = 'https://chat.whatsapp.com/CMw8wmUeBJZ23F3Do9D8rmz'
const grupo3 = 'https://chat.whatsapp.com/GfQ9nskXOaWHN7fHAj384YD'
const grupo4 = 'https://chat.whatsapp.com/CtpC4uVn0k14XPYOt0fwz8o'
const grupo5 = 'https://chat.whatsapp.com/COCca8OBe9MEkR2cs9829rg'
const grupo6 = 'https://chat.whatsapp.com/IHoWJiPLkRcJ8UfREeL8qhC'
const grupo7  = 'https://chat.whatsapp.com/Dxnmx8LHnYTBlshaPq8guL7'
const grupo8 = 'https://chat.whatsapp.com/BsjvTZ3rDAs6X9eQ7T085xx' //jjj
const grupo9 = 'https://chat.whatsapp.com/LZkygD2NUWCAx1ipsJi8Sz9'
const grupo10 = 'https://chat.whatsapp.com/E3p8lq6Ya3o2DIoIh8oKQw1' 
const grupo11 = 'https://chat.whatsapp.com/HPcoGd32atmKZPEbgCYDaO'
const grupo12 = 'https://chat.whatsapp.com/H9qLgMSiT8MBEcfCFXH01X'
const grupo13 = 'https://chat.whatsapp.com/Kd0Wz2njjzQFtlCvvXHTOc'
const grupo14 = 'https://chat.whatsapp.com/HA71eIy3zplGT8WEE1AxrE'
const grupo15 = 'https://chat.whatsapp.com/JE2fYdNALjF4GvKu8nkMRs'
const grupo16 = 'https://chat.whatsapp.com/JTzmR1at00oKh8Q5u8zutT'
let handler = async (m, { conn, text, usedPrefix, command, participants, groupMetadata }) => {

  let fakegif = { key: {participant: `0@s.whatsapp.net`, ...("6289643739077-1613049930@g.us" ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title": 'Nightcore-Bot', "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': '_. ᩭ✎Unete a mi grupo 🍁_', 'jpegThumbnail': false }}}
...
try {
if (!text) return m.reply(`_️. ᩭ✎Ingrese texto/link del grupo_`) 
try {
...
await m.reply(`_. ᩭ✎Enlace anulado o un puto me a elimino de este grupo ${res2}_`)}
try {
let res3 = await conn.groupAcceptInvite(code3)
  await delay(3 * 3000)
...
await m.reply(`_. ᩭ✎Enlace anulado o un puto me elimino de este grupo ${res3}_`)}
try {
let res4 = await conn.groupAcceptInvite(code4)
  await delay(3 * 3000)
