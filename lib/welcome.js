 ...
 * @returns {string}
 */
const genSVG = async ({wid = "", pp = join(galeria, "Welcome-Nightcore-Bot.png"), title = "", name = "", text = "", background = ""} = {}) => {
  let el = {
...
const render = async (
  {
    wid = "",
    pp = toBase64(readFileSync(join(galeria, "Welcome-Nightcore-Bot. png")), "image/png"),
    name = "",
    title = "",
    text = "",
