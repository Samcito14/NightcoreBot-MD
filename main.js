...
ADAPTADO POR JESUS OFC

PERSONALIZACIÓN Y TODO EL DISEÑO DEL BOT
******************************
*/
...
//texto de nuevo admin
  conn.spromote = "_. @user  ᩭ✎a sido promovido a admin del Grupo_";
//texto de admin removido
  conn.sdemote = "_. @user  ᩭ✎a sido removido de admin del Grupo_";
//texto de descripción cambiada
  conn.sDesc = "_. ᩭ✎La descripción del Grupo a sido cambiada_\n_. ᩭ✎Acción echa por : @desc 🍁_";
//texto de nombre cambiado
  conn.sSubject = "_. ᩭ✎El nombre del grupo a sido cambiada\n_. ᩭ✎Acción echa por @subject 🍁_";
//texto de foto del grupo cambiada
  conn.sIcon = "_. ᩭ✎La foto del Grupo a sido cambiada_";
//texto de nuevo enlace
  conn.sRevoke = "_. ᩭ✎El Link del Grupo a sido Resetado_ @revoke";
